...
public class LinkedInCompanyTest {
  ...
  @Test
  public void LinkedInCompanyJsonMappingTest() throws IOException {
    String jsonFilePath = "linkedIn/linkedin-company.json";
    ...
    LinkedInCompanyById expectedLinkedInCompany = LinkedInCompanyById.builder()
            .name("SQLI")
    ...
    LinkedInCompanyById actualLinkedInCompany = objectMapper.readValue(linkedInCompanyAsJson, LinkedInCompanyById.class);
