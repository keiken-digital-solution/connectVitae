...
//
//import io.connectvitae.connectvitaelibrary.linkedIn.models.LinkedInCompanyById;
...
//
//    @Test
//    public void testConvertCompany() {
//        LinkedInCompanyById linkedInCompanyById =
//                LinkedInCompanyById.builder()
//                .name("SQLI")
...
//                .build();
//        Company actualCompany = companyMapper.convertToCompany(linkedInCompanyById);
//
//        Company expectedCompany = Company.builder()
//                .companyName("SQLI")
//                .companyWebSiteUrl("http://www.sqli.com")
//                .companyUniversalName("sqli")
...
//              .companyConfirmedLocations(buildConfirmedLocations())
//               .build();
//
