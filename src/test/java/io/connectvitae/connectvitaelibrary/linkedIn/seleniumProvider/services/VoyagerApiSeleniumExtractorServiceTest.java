...
public class VoyagerApiSeleniumExtractorServiceTest {
    ...
    public void testFetchCertifications() throws IOException, ParseException {
        ...
        expectedCertifications.add(SeleniumCertification.builder()
                ...
                .build());
        List<io.connectvitae.connectvitaelibrary.linkedIn.seleniumProvider.models.SeleniumCertification> actualSeleniumCertifications = dataSeleniumExtractorService.getCertifications("UserId");
