...
public class VoyagerApiProfileTest {
  @Autowired
  private ObjectMapper objectMapper;

  @Test
  public void testVoyagerApiProfileJsonMapping() throws IOException {
    String jsonFilePath = "linkedIn/voyagerApiProvider/elements/linkedin-profile-element.json";

    ClassPathResource resource = new ClassPathResource(jsonFilePath);
    String linkedInProfileAsJson =
        StreamUtils.copyToString(resource.getInputStream(), StandardCharsets.UTF_8);
    VoyagerApiProfile expectedVoyagerApiProfile =
        VoyagerApiProfile.builder()
            ...
            .lastName("Pandey")
            .build();
    VoyagerApiProfile actualVoyagerApiProfile =
        objectMapper.readValue(linkedInProfileAsJson, VoyagerApiProfile.class);
    assertEquals(expectedVoyagerApiProfile, actualVoyagerApiProfile);
  }
}
